    ...
    <main>
        <div class="container">
            <section class="section-stats row justify-content-center" id="stats">
                <div class="col-5 col-md-2 text-center stats-detail">
                    <h2>20K</h2>
                    <p>Member</p>
                </div>
                <div class="col-5 col-md-2 text-center stats-detail ">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 text-center">
                        <img src="{{ url('/frontend/images/logos_partner.png') }}" alt="Logo Partners"
                            class="img-partner">
                    </div>
                </div>
            </div>
